...
class ATMOp(nn.Module):
    ...
    def reset_parameters(self):
        init.kaiming_uniform_(self.weight, a=math.sqrt(5))  # 非负整数 n 的整数平方根
...
class ActiveMLP(nn.Module):
    """
    ActiveMLP https://arxiv.org/abs/2203.06108
    """
    def __init__(
            self, img_size=224, patch_size=4, in_chans=3, num_classes=100,
            depths=[2, 2, 4, 2],
